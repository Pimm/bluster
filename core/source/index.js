...
export default function bluster(target, equalityTester, timeout) {
	const blusteredTarget = function() {
		...
		// If no equality tester was passed, use this default equality tester. Said tester is quite lenient. It is designed
		// to catch obvious inequalities (undefined ≠ 5, or a data object ≠ an error); it is not designed to be a strict,
		// deep equality tester.
